...
Next, we will take each given speed limit and see if the larger numbers correlate to more crashes occurring. This will be illustrated through a histogram model, created from the ggplots2 library in R.
...
Next, we will create a bar chart to 
